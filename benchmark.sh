...
patch_core -b resnet18 -le layer2 -le layer3 --faiss_on_gpu --anomaly_scorer_num_nn 1 --patchsize 3 sampler -p 0.01 approx_greedy_coreset dataset --resize 256 --imagesize 256 "${dataset_flags[@]}" visa $datapath
